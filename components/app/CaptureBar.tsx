...
export function CaptureBar() {
  ...
  return (
    <div className="relative z-10 mt-7 border-t border-[#EFE9DD] pt-6">
      <form onSubmit={submit} className="flex flex-wrap items-center gap-2.5">
        ...
        <div className="flex min-w-0 flex-1 basis-full items-center gap-2.5 rounded-[13px] border border-[#E2DAC9] bg-card px-3.5 py-[3px] focus-within:border-[#CFC6B3] sm:basis-auto">
        ...
        <a
          href="/chat"
          className="inline-flex items-center gap-2 rounded-[11px] border border-[#E2DAC9] bg-card px-3.5 py-[9px] text-[13px] font-semibold text-ink2 no-underline transition hover:border-[#CFC6B3] hover:text-[#3F3A32]"
        >
          💬 Open Chat
        </a>
      </form>
